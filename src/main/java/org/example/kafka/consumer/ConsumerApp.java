...
public class ConsumerApp {
    public static void main(String[] args){
        ...
        partitions.add(new TopicPartition("test", 0)); // Adds a TopicPartition instance representing a topic and a partition.
        partitions.add(new TopicPartition("test", 2)); // Adds an additional TopicPartition instance representing a different partition within the topic. Change as desired.
